...
\begin{mydef}
Množina $\{x_\alpha\} \in R$ se nazývá úplná systém vektorů, jestliže uzávěr podprostoru generovaného množinou $\{x_\alpha\}$ je celý prostor $R$. Je-li $\{x_\alpha\}$ navíc ortogonální (ortonormální) soustavou, nazýváme ji \emph{ortogonální (ortonormální) báze}.
\end{mydef}
