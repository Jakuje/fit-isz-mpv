...
\begin{enumerate}[1)]
	...
	\item $\forall a,b,c \in I: a|b \land b|c \Leftarrow a|c$
	\item $\forall a,b,c \in I: a|b \Leftarrow a|bc$
	\item $\forall a,b,c \in I: a|b \land a|c \Leftarrow a|b+c$
	\item $\forall a,b,c \in I, c \not= 0: a|b \Leftrightarrow ac|bc$
	\item $\forall a,b,c,d \in I: a|b \land c|d \Leftarrow ac|bd$
	\item $\forall a,b \in I, n \in \mathbb{N}: a|b \Leftarrow a^n|b^n$
\end{enumerate}
...
\begin{mydef}
$p \in I \backslash E(I), p \not= 0$ se nazývá prvočinitel: $\Leftrightarrow p|ab \Leftarrow p|a \lor p|b$
\end{mydef}
